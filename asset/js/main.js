...
$(document).ready(function() {
    $(".heart").click(function() {
        ...
        if (img.attr("src") === "./img/heart_icon.png") {
            img.attr("src", "./img/heart_on_icon.png");
        } else {
...
var swiper = new Swiper(".mySwiper", {
    ...
    slidesPerView: 3.2,
    slidesPerGroup: 1, // 슬라이드할 때 1개씩 이동하게 설정

    allowSlideNext: true,  // 다음 슬라이드 이동 허용
    allowSlidePrev: true,  // 이전 슬라이드 이동 허용

    autoHeight: true, // 필요에 따라 슬라이드 높이를 자동으로 맞춤
});
